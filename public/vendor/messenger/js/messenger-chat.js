...
;(function () {
    ...
    function newMessage(message, messageClass, failed = 0) {
        var clas = (messageClass === 'sent') ? 'justify-content-end' : 'justify-content-start'
        if (messageClass === 'sent') {
            $('.messenger-body').append('\
            <div class="row message-row '+clas+' mt-2">\
