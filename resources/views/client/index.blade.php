                            ...
                            <tbody>
                                @if ($cantServiciosPendientes > 0)
                                    @foreach ($serviciosPendientes as $servicio)
                                        <tr>
                                            <td class="text-center">@if (is_null($servicio->date)) 0000-00-00 (Inmediato) @else {{ date('Y-m-d', strtotime($servicio->date)) }} @endif</td>
                                            <td class="text-center">@if (is_null($servicio->time)) 00:00 (Inmediato) @else {{ date('H:i', strtotime($servicio->time)) }} @endif</td>
