...
@push('scripts')
	...
	<script>
            ...
            if ( (document.getElementById("sender_address").value != "") && (document.getElementById("receiver_address").value != "") ){
                ...
                directionsService.route(request, function (response, status) {
                    if (status == google.maps.DirectionsStatus.OK) {
                        ...
                        document.getElementById("total").value = parseInt(rate) + parseInt(document.getElementById("additional_cost").value);
                        ...
                        document.getElementById("total").value = document.getElementById("additional_cost").value;
                ...
                if (document.getElementById("sender_latitude").value == ""){
                    sender();
                    receiver();
                }
            }else{
        ...
        function updateTotal(){
            if (document.getElementById("payment_method").value == 'reembolso'){
                document.getElementById("total").value = parseInt(document.getElementById("rate").value) + parseInt(document.getElementById("additional_cost").value) + parseInt(document.getElementById("refund_amount").value);
            }else{
                document.getElementById("total").value = parseInt(document.getElementById("rate").value) + parseInt(document.getElementById("additional_cost").value);
            }
        }

        function checkStatus(){
            if (document.getElementById("status").value == 0){
                $("#brever_id option[value=0]").attr("selected", true);
                $('#brever_id').removeAttr("required");
                document.getElementById("brever_div").style.display = 'none';
            }else{
                $('#brever_id').prop("required", true);
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append" id="button-addon2">
                                                        <button class="btn btn-primary waves-effect waves-light" type="button" id="receiver_search" style="background-color: #768ADE; color:white;" onclick="receiver();" disabled><i class="fa fa-search"></i></button>
                                                    </div>
                                                </div>
                                            </fieldset><bR>
                                        </div>
                                	...
                                	<form action="{{ route('admin.services.update') }}" method="POST">
                                		...
                                		<div class="row">
                                            ...
                                            <div class="col-sm-4 col-12">
                                                ...
                                                <fieldset class="form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" name="sender_neighborhood" value="{{ $servicio->sender_neighborhood }}">
                                                    <div class="form-control-position">
                                                        <i class="fa fa-city"></i>
                                                    </div>
                                                </fieldset>
                                            ...
                                            <div class="col-sm-4 col-12">
                                                ...
                                                <fieldset class="form-group position-relative has-icon-left">
                                                    <input type="text" class="form-control" name="receiver_neighborhood" value="{{ $servicio->receiver_neighborhood }}">
                                                    <div class="form-control-position">
                                                        <i class="fa fa-city"></i>
                                                    </div>
                                                </fieldset>
											...
											<div class="col-sm-3 col-12">
	                                            ...
	                                            <fieldset class="form-group position-relative has-icon-left">
	                                                <input type="date" class="form-control" name="date" value="{{ $servicio->date }}">
	                                                <div class="form-control-position">
	                                        ...
	                                        <div class="col-sm-3 col-12">
	                                            ...
	                                            <fieldset class="form-group position-relative has-icon-left">
	                                                <input type="time" class="form-control" name="time" value="{{ $servicio->time }}">
	                                                <div class="form-control-position">
	                                        ...
	                                        <div class="col-sm-3 col-12">
	                                            ...
	                                            <fieldset class="form-group position-relative has-icon-left">
	                                                <input type="number" class="form-control" name="additional_cost" id="additional_cost" value="{{ $servicio->additional_cost }}" onkeyup="updateTotal();">
	                                                <div class="form-control-position">
	                                                    <i class="fa fa-dollar"></i>
	                                                </div>
	                                            </fieldset>
	                                        ...
	                                        <div class="col-sm-3 col-12">
	                                            ...
	                                            <fieldset class="form-group position-relative has-icon-left">
	                                                <select class="form-control" name="status" id="status" onchange="checkStatus();" @if (($servicio->status == 4) || ($servicio->status == 5)) disabled @endif>
                                                        ...
                                                        <option value="2" @if ($servicio->status == 2) selected @endif>Iniciado</option>
                                            ...
                                            <div class="col-sm-3 col-12" id="brever_div" @if ($servicio->status == 0) style="display: none;" @endif>
                                                <div class="text-bold-600 font-medium-2 mb-1">
                                                    Brever Asignado
                                                </div>
                                                <fieldset class="form-group position-relative has-icon-left">
                                                   <select class="form-control" name="brever_id" id="brever_id" @if ( ($servicio->status != 0) || ($servicio->status != 5) ) required @endif >
                                                        <option value="0">Seleccione un brever...</option>
                                                        @foreach ($breves as $breve)
                                                            <option value="{{ $breve->id }}" @if ($servicio->brever_id == $breve->id) selected @endif>{{ $breve->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="form-control-position">
