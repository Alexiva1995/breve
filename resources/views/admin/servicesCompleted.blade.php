            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Listado de Servicios Realizados</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <div class="table-responsive">
                            <form action="{{ route('admin.services.completed') }}" method="GET">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-6 text-left">
                                            <a class="btn btn-warning waves-effect waves-light" style="color: white;" href="{{ route('admin.services.completed') }}"><i class="fas fa-redo-alt"></i> Limpiar Filtros</a>
                                        </div> 
                                    </div>
                                </form>
