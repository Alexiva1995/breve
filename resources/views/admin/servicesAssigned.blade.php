                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <form action="{{ route('admin.services.assigned') }}" method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-6 text-left">
                                        <a class="btn btn-warning waves-effect waves-light" style="color: white;" href="{{ route('admin.services.assigned') }}"><i class="fas fa-redo-alt"></i> Limpiar Filtros</a>
                                    </div>   
                                </div>
                            </form>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <a type="button" class="btn btn-outline-primary" href="{{ route('admin.services.confirm', $servicio->id) }}"><i class="fa fa-check"></i> Confirmar</a>
