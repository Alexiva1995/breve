<!DOCTYPE html>
    ...
    <body class="vertical-layout vertical-menu-modern 2-columns navbar-floating footer-static" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
        ...
        <!-- BEGIN: Main Menu-->
        @include('layouts.includes.sidebarBrever')
        <!-- END: Main Menu-->
        ...
        <div class="modal fade text-left show" id="takeConfirmModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel110" aria-modal="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <form action="{{ route('brever.services.take') }}" method="POST">
                    @csrf
                    <input type="hidden" name="service_id" id="take_service_id">
        ...
        <script src="{{ asset('themeforest/app-assets/vendors/js/charts/chart.min.js') }}"></script>
        ...
        <script>
            function loadModal($servicio){
                document.getElementById("take_service_id").value = $servicio;
                $("#takeConfirmModal").modal("show");
            }
        </script>
        @stack('scripts')
    </body>
